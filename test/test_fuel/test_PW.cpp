...
void testPW(void)
{
  ...
  RUN_TEST(test_PW_batt_correction);
  RUN_TEST(test_PW_ae_adder);
  RUN_TEST(test_PW_nitrous_stage1);
  RUN_TEST(test_PW_nitrous_stage2);
  RUN_TEST(test_PW_nitrous_stageboth);
  RUN_TEST(test_pw_calculateRequiredFuel_2stroke);
  RUN_TEST(test_pw_calculateRequiredFuel_4stroke);
  }
}
