...
byte getAdvance2()
{
  ...
  tempAdvance = get3DTableValue(&ignitionTable2, currentStatus.ignLoad, currentStatus.RPM, 1) - scaleCrankAngle(OFFSET_IGNITION); //As above, but for ignition advance
